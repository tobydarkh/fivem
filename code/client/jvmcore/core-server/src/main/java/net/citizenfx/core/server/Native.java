package net.citizenfx.core.server;

import net.citizenfx.core.Vector3;

/**
 * Utility class for invoking game natives from Java (SERVER-SIDE).
 * This provides a bridge to the native function invocation system for server natives.
 */
public class Native {
